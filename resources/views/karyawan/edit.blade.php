    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                        ...
                        <input type="text" id="nik" value="{{ $karyawan->nik }}" class="form-control" placeholder="Nik" name="nik" readonly>
                      </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                        ...
                        <input type="text" id="nama_lengkap" value="{{ $karyawan->nama_lengkap }}" class="form-control" placeholder="Nama Lengkap"  name="nama_lengkap">
                      </div>
        </div>
    </div>
    <div class="row">
