...
<div class="section" id="user-section">
    ...
    <div id="user-detail">
        <div class="avatar">
            ...
            @endphp
            <img src="{{ url($path) }}" alt="avatar" class="img">
            @else
            <img src="assets/img/sample/avatar/avatar1.jpg" alt="avatar" class="img">
            @endif
        </div>
        <div id="user-info">
                    ...
                    <li>
                        <div class="item">
                            ...
                            <div class="in">
                                ...
                                <span class=" badge {{ $d->jam_in < "08:00" ? "bg-success" : "bg-success" }}">
                                    {{ $d->jam_in }}
                                </span>
                            </div>
                        </div>
